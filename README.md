...
- **web_search_advanced_exa**: Advanced web search with full control over filters like category, domain, date range, highlights, summaries, and subpage crawling. Use claude skills or carefully prompt the LLM for optimal results.
