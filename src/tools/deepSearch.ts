...
Note: Requires an Exa API key. 'deep' mode takes 4-12s, 'deep-reasoning' takes 12-50s.`,
    {
      ...
      highlightMaxCharacters: z.coerce.number().min(1).optional().catch(undefined).describe("Maximum characters for highlights per result (must be a positive number, default: 4000)"),
