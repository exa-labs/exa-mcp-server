...
Note: This tool does NOT support deep search. For deep search with query expansion and synthesized answers, use the deep_search_exa tool instead.`,
    {
      ...
      category: z.enum(['company', 'research paper', 'people']).optional().describe("Filter results to a specific category. Must be one of: 'company', 'research paper', 'people'. Omit if no specific category is needed."),
