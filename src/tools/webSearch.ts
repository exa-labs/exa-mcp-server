...
Returns: Clean text content from top search results, ready for LLM use.`,
    {
      ...
      category: z.enum(['company', 'research paper', 'news', 'pdf', 'github', 'tweet', 'personal site', 'people', 'financial report']).optional().describe("Filter results to a specific category - 'company': company websites and profiles, 'research paper': academic papers and research, 'news': news articles, 'pdf': PDF documents, 'github': GitHub repositories, 'tweet': tweets, 'personal site': personal websites, 'people': LinkedIn profiles and personal bios, 'financial report': financial reports and filings"),
