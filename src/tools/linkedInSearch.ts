  ...
  server.tool(
    ...
    async ({ query, numResults }) => {
      ...
      try {
        ...
        const deprecationNotice = "\n\nâš ï¸ DEPRECATION NOTICE: This tool (linkedin_search_exa) is deprecated. Please use 'people_search_exa' instead for future requests.";
        ...
        if (axios.isAxiosError(error)) {
          ...
          return {
            content: [{
              type: "text" as const,
              text: `LinkedIn search error (${statusCode}): ${errorMessage}\n\nâš ï¸ Note: This tool is deprecated. Please use 'people_search_exa' instead.`
            }],
            isError: true,
          };
        }
